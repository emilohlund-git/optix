 ...
 */
export function processNeighbor<T extends Point>(
  currentNode: PathfindingNode<T>,
  neighbor: GraphNode<T>,
  goal: PathfindingNode<T>,
  openSet: PathfindingNode<T>[],
  closedSet: GraphNode<T>[],
  heuristic: (node: GraphNode<T>) => number
): void {
