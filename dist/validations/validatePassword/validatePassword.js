...
function validatePassword(password, options) {
    ...
    const { minLength = 8, maxLength = 100, requireUppercase = true, requireLowercase = true, requireNumbers = true, requireSpecialCharacters = true, disallowRepeatedCharacters = true, allowedNumberOfRepeatingCharacters = 2, disallowSequentialCharacters = true, customMessages = {}, } = options || {};
    ...
    if (disallowRepeatedCharacters && strings_1.StringUtils.isRepeating(password, allowedNumberOfRepeatingCharacters)) {
    ...
    if (disallowSequentialCharacters && strings_1.StringUtils.hasSequential(password)) {
